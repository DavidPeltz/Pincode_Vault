    ...
    >
      ...
      <View style={[styles.section, { backgroundColor: theme.surface }]}>
        <Text style={[styles.sectionTitle, { color: theme.text }]}>
          🔐 Welcome to PIN Vault v1.5
        </Text>
        <Text style={[styles.overviewText, { color: theme.textSecondary }]}>
          Securely store your bank and credit card PINs using a unique visual grid system. Your PINs
          are hidden among random digits in colorful grids, protected by device authentication and
          encrypted backups.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.surface }]}>
        ...
        <Text style={[styles.instructionText, { color: theme.textSecondary }]}>
          1. Tap the <Text style={{ fontWeight: 'bold', color: theme.primary }}>+</Text> button
          below to create your first PIN grid
        </Text>
        <Text style={[styles.instructionText, { color: theme.textSecondary }]}>
      ...
      {!isAuthAvailable && (
        ...
        >
          ...
          <View style={styles.authMethodsList}>
            <Text style={[styles.authMethod, { color: theme.textSecondary }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.surface }]}>
        ...
        <Text style={[styles.instructionText, { color: theme.textSecondary }]}>
          • <Text style={{ fontWeight: 'bold' }}>Visual Obfuscation:</Text> PINs hidden among decoy
          digits
        </Text>
        <Text style={[styles.instructionText, { color: theme.textSecondary }]}>
          • <Text style={{ fontWeight: 'bold' }}>Biometric Protection:</Text>{' '}
          {biometricType || 'Device'} authentication required
        </Text>
        <Text style={[styles.instructionText, { color: theme.textSecondary }]}>
          • <Text style={{ fontWeight: 'bold' }}>Encrypted Backups:</Text> Password-protected with
          strong encryption
        </Text>
        <Text style={[styles.instructionText, { color: theme.textSecondary }]}>
          • <Text style={{ fontWeight: 'bold' }}>Offline Storage:</Text> No cloud servers, your data
          stays local
        </Text>
      </View>
